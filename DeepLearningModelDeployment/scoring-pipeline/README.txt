...
- The scoring module and scoring service are supported only on Linux x86_64 with 
...
(Requires Linux x86_64 and Python 3.6. See Appendix A.)
...
(Requires Linux x86_64, Python 3.6 and Thrift. See Appendix A, B.)
...
- By default, the run_*.sh scripts mentioned above create a virtual environment
  ...
  and install reqired package dependencies. The package manager to use is provided 
...
In effect, this mechansim allows you to invoke scoring functions from languages 
